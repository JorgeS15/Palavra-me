...
INFO = SourceInfo(
    ...
    license=License(
        ...
        redistributable=None,   # decisão do Jorge: sem termos publicados
        verified=False,
        notes=(
            "Verificado em 2026-07-30, sem conclusão possível: o site do VOC "
            "não publica termos de uso nem dump descarregável — só consulta "
            "palavra a palavra ('Apresentação' e 'Ficha técnica' não dizem "
            "nada sobre reutilização). Argumentos: (a) uma lista de palavras "
            "de uma língua tem pouca originalidade e em vários ordenamentos "
            "não é protegível por direito de autor — mas é opinião, não "
            "verificação; (b) sem dump, usar o VOC obriga a extração em "
            "massa do site, que é agressiva e provavelmente indesejada pelo "
            "IILP. Opções: email ao IILP (iilp.cplp.org) a pedir a lista e "
            "os termos, ou correr o pipeline em modo permissivo sem VOC, "
            "usando o Hunspell do Natura como autoridade prática da grafia "
            "AO90. Decisão em aberto."
        ),
    ),
    provides=("lemmas",),
    primary="voc.csv",
